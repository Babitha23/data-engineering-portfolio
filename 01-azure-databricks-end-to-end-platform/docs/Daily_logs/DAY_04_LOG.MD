...
Day 4 - Silver Layer Transformation (Energy Trends – ET 5.1) <br>
...
- Silver Delta tables for ET 5.1:
	- energy_generation_trends_main
	- energy_generation_trends_annual
	- energy_generation_trends_quarterly
